            ...
            <div class="header-top-inner">
                <div class="cnt-account">
                    <ul class="list-unstyled">
                        ...
                        @else
                            <a href="{{ route('login') }}"><i class="icon fa fa-lock"></i>Login/Regster</a></li>
                    ...
                    <ul class="list-unstyled list-inline">
                        ...
                        <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle"
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @else
                                    <li><a href="{{ route('hindi.language') }}">JP</a></li>
                                @endif
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        @foreach ($subcategories as $subcategory)
                                                            <div class="col-xs-12 col-sm-12 col-md-2 col-menu">
                                                                ...
                                                                @php
                                                                    $subcategories = App\Models\SubSubCategory::where('subcategory_id', $subcategory->id)
